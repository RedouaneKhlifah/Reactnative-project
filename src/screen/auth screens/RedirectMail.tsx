...
const RedirectMail = () => {
  ...
  return (
    <KeyboardAvoidingView
      style={{display: 'flex', width: SIZES.width, height: SIZES.height}}
      ...
      <ScrollView contentContainerStyle={styles.scrollView}>
        <View style={styles.container}>
          ...
          <Image
            source={Images.mails}
            style={{width: responsiveWidth(238), height: responsiveHeight(238)}}
          />
          <View
            style={{
              display: 'flex',
            ...
            <View style={{display: 'flex', flexDirection: 'row'}}>
              ...
              <Pressable>
                <Text style={{textAlign: 'center', color: '#AB82FF'}}>
                  Renvoyer le code
                </Text>
              </Pressable>
            </View>
